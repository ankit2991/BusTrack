    ...
    if (service is AndroidServiceInstance) {
      ...
      Timer.periodic(Duration(seconds: 1), (timer) async {
       ...
       await api.get_loc().then((value) async{
          ...
          print(res);
            print("longitude= " +value.longitude.toStringAsFixed(6) + " " + "latitude= " + value.latitude.toStringAsFixed(6));
          if (res >= 0.55) {
          print("${++a}");
            ...
            await api.send_let_log(Divice_Id: "1", lat: let.toStringAsFixed(6), long: lot.toStringAsFixed(6));
          }
          // }
        });
        if (service is AndroidServiceInstance) {
